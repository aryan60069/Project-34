...
function draw() {
  ...
  textSize(22);
  text("Save the World!",100,20);
  text("Drag the hero and finish the game of the monster",10,50);

  if(monster.body.position.y > 650 || monster.body.position.x > 1350){
    textSize(35);
    fill("yellow");
    stroke("black");
    strokeWeight(4);
    text("Yay! You killed the Monster and saved the World", 200, 140);
  }
